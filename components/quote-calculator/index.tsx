...
return (
    <>
      ...
      <div
        className={cn(
          "fixed z-[9992] right-4 md:right-6 bottom-28 flex items-center justify-end group/calc",
      ...
      {isOpen && (
        <div
          ...
          className={cn(
            "fixed bottom-28 right-4 left-4 md:left-auto md:right-6 z-[9991] md:w-[400px] max-h-[75vh] rounded-[20px] shadow-2xl flex flex-col overflow-hidden transform-gpu abh-calc-grow",
            GLASS.panel
          )}
