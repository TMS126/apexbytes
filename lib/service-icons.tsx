...
const ICONS = {
  "B&W Print / Copy": "Printer", "Colour Print / Copy": "Palette", "Bulk Printing": "Stack", "Glossy Photo (4×6)": "Image", "Glossy Photo (A4)": "Images",
  "Typing + Print (B&W)": "Keyboard", "Typing + Print (Colour)": "Article", "Affidavit / Letter Typing": "FileText", "CV Creation": "ReadCvLogo", "CV Revamp": "NotePencil", "Cover Letter": "Envelope", "Scanning to Digital": "Scan", "Laminating (A5)": "Shield", "Laminating (A4)": "ShieldCheck", "Laminating (A3)": "SealCheck",
