...
export const TYPE_SCALE = {
  ...
  cardHeading:   { class: "abh-card-heading",    css: "font-heading font-medium text-base md:text-lg tracking-tight leading-snug" },
  eyebrow:       { class: "abh-eyebrow",         css: "font-sans font-medium text-xs uppercase tracking-[0.2em]" },
  body:          { class: "abh-body",            css: "font-sans font-normal text-base leading-relaxed" },
  muted:         { class: "abh-muted",           css: "font-sans font-normal text-sm md:text-base leading-relaxed" },
  price:         { class: "abh-price",           css: "font-heading font-medium text-2xl md:text-3xl leading-none" },
  btnLabel:      { class: "abh-btn-label",       css: "font-sans font-medium text-base" },
